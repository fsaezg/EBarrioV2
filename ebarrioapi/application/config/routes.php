...
// Routes for consumohistorico
$route['consumohistorico']['get'] = 'consumohistorico/index';
$route['consumohistorico/(:num)']['get'] = 'consumohistorico/find/$1';
$route['consumohistorico']['post'] = 'consumohistorico/index';
$route['consumohistorico/(:num)']['put'] = 'consumohistorico/index/$1';
$route['consumohistorico/(:num)']['delete'] = 'consumohistorico/index/$1';
//login user routes
