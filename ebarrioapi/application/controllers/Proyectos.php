...
class Proyectos extends REST_Controller
{
    ...
    {
        $proyectos = $this->proyectos_model->getProyecto();
    ...
    public function index_post()
    {
        ...
        $id = $this->proyectos_model->saveProyecto($this->post('proyecto'));
    ...
    public function index_put()
    {
        ...
        $update = $this->proyectos_model->updateProyecto($this->put('proyecto'));
    ...
    public function index_delete($id)
    {
        ...
        $delete = $this->proyectos_model->deleteProyecto($id);
