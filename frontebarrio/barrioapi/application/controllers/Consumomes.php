...
class Consumomes extends REST_Controller
{
    ...
    {
        $consumo = $this->consumomes_model->getSpending();
    ...
    public function find_get($id)
    {
        ...
        $consumo = $this->consumomes_model->getSpending($id);
    ...
    public function index_post()
    {
        ...
        $id = $this->consumomes_model->saveSpending($this->post('consumo'));
    ...
    public function index_put()
    {
        ...
        $update = $this->consumomes_model->updateSpending($this->put('consumo'));
    ...
    public function index_delete($id)
    {
        ...
        $delete = $this->consumomes_model->deleteSpending($id);

        if (!is_null($delete)) {
            $this->response(array('response' => 'Consumo eliminado!'), 200);
        } else {
            $this->response(array('error', 'Algo se ha roto en el servidor...'), 400);
        }
    }
